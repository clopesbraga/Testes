...
Pagina_Alerta automacaobatista= new Pagina_Alerta();
	...
	{		
		automacaobatista.verificaElementoTexto("Mudança de foco");
	...
	{	
		...
		automacaobatista.Clicar("Step 4","@Entao:","Realizar os testes no botão JS Alert");	
		
		automacaobatista.verificaElementoBotao("Eu sou um alerta JS!");	
		automacaobatista.Clicar("Step 5","@Entao:","Realizar os testes no botão JS Alert");	
		
		//automacaobatista.verificaElementoTexto("Voltar");	
		//automacaobatista.Clicar("Step 6","@Entao:","Realizar os testes no botão JS Alert");	
