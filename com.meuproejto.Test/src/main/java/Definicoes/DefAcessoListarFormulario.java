...
public class DefAcessoListarFormulario  {
	...
	public void clicar_em_listar_usuarios() throws Throwable {
		...
		automacaobatista.verificaElementoTexto("Lista de Usuários"); automacaobatista.Clicar();		
	...
	public void Passar_pelas_paginas() throws Throwable 
	{
		...
		automacaobatista.verificaElementoTexto("Próximo"); automacaobatista.Clicar();
		automacaobatista.verificaElementoTexto("Próximo"); automacaobatista.Clicar();
		automacaobatista.verificaElementoTexto("Próximo"); automacaobatista.Clicar();		
